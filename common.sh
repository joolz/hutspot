...
DXP72BASEDIR=/opt/dxp72
DXP72SOURCEPHYSICALDIR=liferay-dxp-src-7.2.10.1-sp1
DXP72SOURCEZIP=liferay-dxp-src-7.2.10.1-sp1-20191007154602574.zip
DXP72SOURCEDIR=$DXP72BASEDIR/src
DXP72SERVERZIP=liferay-dxp-tomcat-7.2.10.1-sp1-20191009103614075.tar.gz
DXP72SERVERPHYSICALDIR=liferay-dxp-7.2.10.1-sp1
DXP72SERVERDIR=$DXP72BASEDIR/server
DXP72TOMCATDIR=$DXP72SERVERDIR/tomcat-9.0.17
